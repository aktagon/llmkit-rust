...
//!
//! Phase 2b emits skeleton structs + `unimplemented!()` terminals;
//! phase 3 will hand-write a subset of terminals against the legacy
//! free-function runtime in sibling files. Phase 4 will move this
//! surface into the main module once the legacy functional API is
//! deleted.
...
impl Text {
    ...
    pub async fn prompt(self, msg: impl Into<String>) -> Result<Response, Error> {
        let _ = msg;
        unimplemented!("plan 016 phase 3: Text::prompt not yet implemented")
    }

    pub async fn stream(self, msg: impl Into<String>) -> Result<Response, Error> {
        let _ = msg;
        unimplemented!("plan 016 phase 3: Text::stream not yet implemented")
    }

    pub async fn batch(self, prompts: Vec<String>) -> Result<Vec<Response>, Error> {
        let _ = prompts;
        unimplemented!("plan 016 phase 3: Text::batch not yet implemented")
    }

    pub async fn submit_batch(self, prompts: Vec<String>) -> Result<BatchHandle, Error> {
        let _ = prompts;
        unimplemented!("plan 016 phase 3: Text::submit_batch not yet implemented")
    }
...
impl Image {
    ...
    pub async fn generate(self, msg: impl Into<String>) -> Result<ImageResponse, Error> {
        let _ = msg;
        unimplemented!("plan 016 phase 3: Image::generate not yet implemented")
    }
...
impl Agent {
    ...
    pub async fn prompt(self, msg: impl Into<String>) -> Result<Response, Error> {
        let _ = msg;
        unimplemented!("plan 016 phase 3: Agent::prompt not yet implemented")
    }

    pub fn reset(self) {
        unimplemented!("plan 016 phase 3: Agent::reset not yet implemented")
    }
...
impl Upload {
    ...
    pub async fn run(self) -> Result<File, Error> {
        unimplemented!("plan 016 phase 3: Upload::run not yet implemented")
    }
